...
var j7 = Y(function(o20, l19) {
  ...
  }), u25 ? (0, import_react_dom7.createPortal)(import_react88.default.createElement("div", { "data-headlessui-portal": "", ref: (a28) => {
    ...
    switch (e9.actions.setIsTyping(true), t14.key) {
      ...
      case o8.ArrowUp:
        return t14.preventDefault(), t14.stopPropagation(), u(e9.state.comboboxState, { [P5.Open]: () => e9.actions.goToOption({ focus: c12.Previous }), [P5.Closed]: () => {
          (0, import_react_dom8.flushSync)(() => e9.actions.openCombobox()), o20.value || e9.actions.goToOption({ focus: c12.Last });
        } });
      case o8.Home:
...
function Fo(T10, O5) {
  ...
  let X5 = o4((l19) => {
    switch (l19.key) {
      case o8.Space:
      case o8.Enter:
        l19.preventDefault(), l19.stopPropagation(), e9.state.comboboxState === P5.Closed && (0, import_react_dom8.flushSync)(() => e9.actions.openCombobox()), A5();
        return;
      case o8.ArrowDown:
        l19.preventDefault(), l19.stopPropagation(), e9.state.comboboxState === P5.Closed && ((0, import_react_dom8.flushSync)(() => e9.actions.openCombobox()), e9.state.dataRef.current.value || e9.actions.goToOption({ focus: c12.First })), A5();
        return;
      case o8.ArrowUp:
        l19.preventDefault(), l19.stopPropagation(), e9.state.comboboxState === P5.Closed && ((0, import_react_dom8.flushSync)(() => e9.actions.openCombobox()), e9.state.dataRef.current.value || e9.actions.goToOption({ focus: c12.Last })), A5();
        return;
      case o8.Escape:
        if (e9.state.comboboxState !== P5.Open) return;
        l19.preventDefault(), e9.state.optionsElement && !o20.optionsPropsRef.current.static && l19.stopPropagation(), (0, import_react_dom8.flushSync)(() => e9.actions.closeCombobox()), A5();
        return;
      default:
        return;
    }
...
function Et(b14, E13) {
  ...
  let h15 = o4((r21) => {
    ...
    var M12;
    a28.state.listboxState === F6.Open ? ((0, import_react_dom9.flushSync)(() => a28.actions.closeListbox()), (M12 = a28.state.buttonElement) == null || M12.focus({ preventScroll: true })) : (r21.preventDefault(), a28.actions.openListbox({ focus: c12.Nothing }));
...
function ot(m10, y10) {
  ...
  let T10 = s8((t14) => {
    var S10;
    s20 || (b14 === P7.Open ? ((0, import_react_dom10.flushSync)(() => l19.send({ type: C9.CloseMenu })), (S10 = f21.current) == null || S10.focus({ preventScroll: true })) : (t14.preventDefault(), l19.send({ type: C9.OpenMenu, focus: { focus: c12.Nothing }, trigger: D11.Pointer })));
...
function at(m10, y10) {
  ...
  let z4 = p(), le = o4((e9) => {
    ...
    switch (z4.dispose(), e9.key) {
      ...
      case o8.Escape:
        e9.preventDefault(), e9.stopPropagation(), (0, import_react_dom10.flushSync)(() => o20.send({ type: C9.CloseMenu })), (Z4 = o20.state.buttonElement) == null || Z4.focus({ preventScroll: true });
        break;
      case o8.Tab:
        e9.preventDefault(), e9.stopPropagation(), (0, import_react_dom10.flushSync)(() => o20.send({ type: C9.CloseMenu })), R3(o20.state.buttonElement, e9.shiftKey ? T4.Previous : T4.Next);
        break;
      default:
