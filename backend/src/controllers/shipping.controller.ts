 ...
 */
export const getShippingMethods = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const getShippingMethodById = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
export const deleteShippingMethod = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
    const methodId = BigInt(id as string);
 ...
 */
export const calculateShippingFee = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
