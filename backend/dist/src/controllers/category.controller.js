...
const serializeCategory = (category) => {
    return JSON.parse(JSON.stringify(category, (key, value) => typeof value === 'bigint' ? value.toString() : value));
};
    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                products: products.map(p => JSON.parse(JSON.stringify(p, (key, value) => typeof value === 'bigint' ? value.toString() : value))),
                pagination: {
                    page: pageNum,
                    limit: limitNum,
                    total,
