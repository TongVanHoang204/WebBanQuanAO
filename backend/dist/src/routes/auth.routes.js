...
import { register, login, googleLogin, getMe, updateProfile, changePassword, forgotPassword, resetPassword, getMyActivity, getAddresses, addAddress, updateAddress, deleteAddress, setDefaultAddress, verify2FA, toggle2FA } from '../controllers/auth.controller.js';
